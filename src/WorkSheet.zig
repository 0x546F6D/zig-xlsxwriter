...
pub const ConditionalFormat = extern struct {
    ...
    min_color: Format.DefinedColors = .black,
    mid_value: f64 = 0,
    mid_value_string: [*c]const u8 = null,
    mid_rule_type: ConditionalFormatRuleTypes = .none,
    mid_color: Format.DefinedColors = .black,
    max_value: f64 = 0,
    max_value_string: [*c]const u8 = null,
    max_rule_type: ConditionalFormatRuleTypes = .none,
    max_color: Format.DefinedColors = .black,
    bar_color: Format.DefinedColors = .black,
    bar_only: u8 = 0,
    data_bar_2010: u8 = 0,
    bar_solid: u8 = 0,
    bar_negative_color: Format.DefinedColors = .black,
    bar_border_color: Format.DefinedColors = .black,
    bar_negative_border_color: Format.DefinedColors = .black,
    ...
    bar_axis_color: Format.DefinedColors = .black,
