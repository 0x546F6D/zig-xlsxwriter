pub fn main() !void {
    ...
    try worksheet.setColumn(.{ .first = 2, .last = 2 }, 25, .default, null);
    try worksheet.setRow(2, 50, .default, null);
    ...
    try worksheet.writeComment(.{ .row = 2, .col = 2 }, "This is a comment.", null);
    ...
    try worksheet.writeComment(.{ .row = 5, .col = 2 }, "Hello.", null);

    // Example 3: Worksheet level comment visibility
    worksheet = worksheet3;
    try worksheet.setColumn(.{ .first = 2, .last = 2 }, 25, .default, null);
    try worksheet.setRow(2, 50, .default, null);
    try worksheet.setRow(5, 50, .default, null);
    try worksheet.setRow(8, 50, .default, null);
    ...
    try worksheet.writeComment(.{ .row = 2, .col = 2 }, "Hello", options3a);
    ...
    try worksheet.setRow(5, 50, .default, null);
    try worksheet.setRow(8, 50, .default, null);
    try worksheet.setRow(15, 50, .default, null);
    try worksheet.setRow(18, 50, .default, null);
    ...
    try worksheet.writeComment(.{ .row = 2, .col = 2 }, "Hello", .default);
    ...
    try worksheet.writeComment(.{ .row = 5, .col = 2 }, "Hello", options4a);
    ...
    try worksheet.writeComment(.{ .row = 2, .col = 2 }, "Hello", null);
    ...
    try worksheet.writeComment(.{ .row = 5, .col = 2 }, "Hello", options5a);
    ...
    try worksheet.writeComment(.{ .row = 8, .col = 2 }, "Hello", options5b);
    ...
    try worksheet.writeComment(.{ .row = 2, .col = 2 }, "Hello", options6a);
    ...
    try worksheet.writeComment(.{ .row = 8, .col = 2 }, "Hello", options6b);

    // Example 7: Comment author
    worksheet = worksheet7;
    try worksheet.setColumn(.{ .first = 2, .last = 2 }, 30, .default, null);
    try worksheet.setRow(2, 50, .default, null);
    try worksheet.setRow(5, 60, .default, null);
    ...
    try worksheet.setColumn(.{ .first = 2, .last = 2 }, 25, .default, null);
    try worksheet.setRow(2, 80, .default, null);
    ...
    try worksheet.writeComment(cell, "Hello", null);
