...
pub fn main() !void {
    ...
    const chart1 = xlsxwriter.workbook_add_chart(workbook, xlsxwriter.LXW_CHART_AREA);

    // Add the first series to the chart
    series = xlsxwriter.chart_add_series(chart1, "=Sheet1!$A$2:$A$7", "=Sheet1!$B$2:$B$7");
    ...
    const chart2 = xlsxwriter.workbook_add_chart(workbook, xlsxwriter.LXW_CHART_AREA_STACKED);
    ...
    const chart3 = xlsxwriter.workbook_add_chart(workbook, xlsxwriter.LXW_CHART_AREA_STACKED_PERCENT);
