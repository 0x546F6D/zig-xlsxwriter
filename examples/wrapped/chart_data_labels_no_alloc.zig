pub fn main() !void {
    ...
    var data_label_1: DataLabel = .{ .value = "Amy" };
    var data_label_2: DataLabel = .{ .value = "Bea" };
    var data_label_3: DataLabel = .{ .value = "Eva" };
    var data_label_4: DataLabel = .{ .value = "Fay" };
    var data_label_5: DataLabel = .{ .value = "Liv" };
    var data_label_6: DataLabel = .{ .value = "Una" };

    // Create an array of label pointers.
    const data_labels5: DataLabelArray = &.{
        &data_label_1,
        &data_label_2,
        &data_label_3,
        &data_label_4,
    ...
    try series.setLabelsCustomNoAlloc(data_labels5);
    ...
    // Create an array of label pointers.
    const data_labels6: DataLabelArray = &.{
        &data_label_1,
        &data_label_2,
        &data_label_3,
        &data_label_4,
    ...
    // Set the custom labels.
    try series.setLabelsCustomNoAlloc(data_labels6);
    ...
    // Set the custom labels.
    try series.setLabelsCustomNoAlloc(data_labels7);
    ...
    // Create some custom labels.
    const hide: DataLabel = .{ .hide = 1 };
    const keep: DataLabel = .{ .hide = 0 };

    // Create an array of label pointers.
    const data_labels8: DataLabelArray = &.{
        &hide,
        &keep,
        &hide,
        &hide,
    ...
    // Set the custom labels.
    try series.setLabelsCustomNoAlloc(data_labels8);
    ...
    // Create some custom labels.
    data_label_1 = .{ .value = "Amy", .line = @constCast(&line3.toC()) };
    data_label_2 = .{ .value = "Bea" };
    data_label_3 = .{ .value = "Eva" };
    data_label_4 = .{ .value = "Fay" };
    data_label_5 = .{ .value = "Liv" };
    data_label_6 = .{ .value = "Una", .fill = @constCast(&fill3.toC()) };
    ...
    // Create an array of label pointers.
    const data_labels9: DataLabelArray = &.{
        &data_label_1,
        &data_label_2,
        &data_label_3,
        &data_label_4,
    ...
    // Set the custom labels.
    try series.setLabelsCustomNoAlloc(data_labels9);
...
const DataLabel = xwz.ChartDataLabelNoAlloc;
const DataLabelArray = xwz.ChartDataLabelNoAllocArray;
