...
pub fn main() !void {
    const workbook = lxw.workbook_new("zig-chart_line.xlsx");
    ...
    var series = lxw.chart_add_series(chart, "=Sheet1!$A$2:$A$7", "=Sheet1!$B$2:$B$7");
    ...
    //
    chart = lxw.workbook_add_chart(workbook, lxw.LXW_CHART_LINE_STACKED);
    ...
    //
    chart = lxw.workbook_add_chart(workbook, lxw.LXW_CHART_LINE_STACKED_PERCENT);
